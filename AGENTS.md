...
9. **Movimiento de marca nacido del producto, no efectos sueltos.** Biblioteca aprobada: roller sunscreen que baja/cubre/sube, comparador de luz táctil, tela física que responde al puntero, trama reactiva y Cota activa. Todo movimiento explica cortina, material, luz o medida. En producción no hay loops decorativos en botones, textos, fondos o métricas. `prefers-reduced-motion` mantiene operabilidad e información sin recorrido.
